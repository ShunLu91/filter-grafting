...
if args.cifar == 10:
    ...
    trainset = torchvision.datasets.CIFAR100(root='../data/cifar', train=True, download=True, transform=transform_train)
    testset = torchvision.datasets.CIFAR100(root='../data/cifar', train=False, download=True, transform=transform_test)
