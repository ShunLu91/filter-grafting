...
CUDA_VISIBLE_DEVICES=0 nohup python grafting.py -g 0 --s checkpoint/grafting_cifar10_mobilenetv2_3 --cifar 10  --model mobilenetv2 --num 3 --i 1 >checkpoint/grafting_cifar10_mobilenetv2_3/1.log 2>&1 &
CUDA_VISIBLE_DEVICES=1 nohup python grafting.py -g 1 --s checkpoint/grafting_cifar10_mobilenetv2_3 --cifar 10  --model mobilenetv2 --num 3 --i 2 >checkpoint/grafting_cifar10_mobilenetv2_3/2.log 2>&1 &
CUDA_VISIBLE_DEVICES=2 nohup python grafting.py -g 2 --s checkpoint/grafting_cifar10_mobilenetv2_3 --cifar 10  --model mobilenetv2 --num 3 --i 3 >checkpoint/grafting_cifar10_mobilenetv2_3/3.log 2>&1 &
