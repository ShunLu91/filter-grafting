...
CUDA_VISIBLE_DEVICES=0 nohup python baseline.py --s checkpoint/baseline_cifar10_mobilenetv2 --cifar 10  --model mobilenetv2 >checkpoint/baseline_cifar10_mobilenetv2/1.log &
